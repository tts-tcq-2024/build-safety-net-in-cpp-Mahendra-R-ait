...
TEST(SoundexTest, HandlesLongNames) {
    EXPECT_EQ(generateSoundex("Devaraj"), "D123");
    EXPECT_EQ(generateSoundex("Mahendra"), "M230");
...
TEST(SoundexTest, HandlesHyphensAndSpaces) {
    EXPECT_EQ(generateSoundex("Rama-Rao"), "R362");
    EXPECT_EQ(generateSoundex("Dhinakaran-Koilpitchai"), "D526");
